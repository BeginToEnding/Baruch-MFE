...
def build_features_for_date(
    ...
    # ---------- 4) intraday residual return scaled by volatility ----------
    feat["intraday_resid_ret_vol"] = _safe_div(feat["cumret_resid_1530"], feat["EST_VOL"])

    # ---------- 5) overnight return scaled by volatility ----------
    ...
    # ---------- 10) previous day cumulative residual at 16:00 (vol-scaled) ----------
    ...
    # ---------- 12) common-factor return scaled by daily volatility ----------
    feat["common_factor_ret_vol"] = _safe_div(
        feat["cumret_raw_1530"] - feat["cumret_resid_1530"],
        feat["EST_VOL"]
    )

    # ---------- 13) negative-return illiquidity ----------
    if daily_Tm1 is not None:
    ...
    # ---------- frighten_mean_L / frighten_std_L ----------
